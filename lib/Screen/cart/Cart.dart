                                    ...
                                    if (int.parse(cartList[index]
                                      ...
                                      setState(() async {
                                        ...
                                        context
                                            .read<CartProvider>()
                                            .setProgress(true);
                                        await saveForLaterFun(index,
                                            selectedPos, total, cartList);
                                      });
                                    } else {
                                      context
                                          .read<CartProvider>()
...
//2
  ...
  isBuyNow(String? id, String? qty, double price, SectionModel curItem,
      int selectedPos,
      {int? selIndex}) async {
    _isNetworkAvailable = await isNetworkAvailable();
    if (_isNetworkAvailable) {
